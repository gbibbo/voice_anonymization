...
The dataset is segmented into 14 folders, with each set of two consecutive folders representing recordings from the same participant. The dataset has been distributed across three separate Zenodo repositories due to its size.
